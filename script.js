...
if (placementSection) {
  placementSection.classList.add('has-placement-videos');
  placementSection.style.paddingTop = '34px';
  placementSection.insertAdjacentHTML('afterbegin', `
    <div class="placement-video-intro"><p class="eyebrow"><i></i> LATEST FROM RV CONSULTING</p><h2>Watch our latest YouTube video<br>for more information.</h2></div>
